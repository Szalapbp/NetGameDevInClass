...
namespace Unity.Multiplayer.Center.NetcodeForEntitiesExample
{
    ...
    public partial struct GoInGameServerSystem : ISystem 
    {
        ...
        public void OnUpdate(ref SystemState state)
        {
            ...
            var spawnPT = GetSpawnPoint(spawnPointLtWs);
        ...
        private float3 GetSpawnPoint(NativeArray<LocalToWorld> spawnPointLtWs)
        {
            int rngIndex = UnityEngine.Random.Range(0, spawnPointLtWs.Length);
            Debug.Log("Spawning at POS: " + rngIndex);
            return spawnPointLtWs[rngIndex].Position;
        }
    }
}
